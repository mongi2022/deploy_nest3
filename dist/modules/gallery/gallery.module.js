...
GalleryModule = __decorate([
    (0, common_1.Module)({
        imports: [typeorm_1.TypeOrmModule.forFeature([gallery_entity_1.GalleryEntity, property_entity_1.PropertyEntity]),
            platform_express_1.MulterModule.register({
                dest: './images',
            })],
        controllers: [gallery_controller_1.GalleryController],
        providers: [gallery_service_1.GalleryService, property_service_1.PropertyService],
    })
], GalleryModule);
